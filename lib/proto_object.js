			...
			var parse_args = (function(args) {
				...
				for ( var x = 0; x < args.length; x++ ) {
					...
					if ( Object.prototype.toString.call(args[x]) === "[object Arguments]" ) {
						...
						if ( typeof opt === "string" ) {
							...
							for ( var n in opt ) {
								...
								if ( n in this.list() ) {
									...
									new this.parent(this, {level: this.internal_level, log_title: "Bracket Print Error"})
						...
						return new this.parent(this, {level: this.internal_level, log_title: "Bracket Print Error"})
