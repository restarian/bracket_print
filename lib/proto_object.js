...
console.log("222222")
			var print = this//this._is_chained && this || new this.parent(this)
...
console.log(n, opt[n])
			...
			//						return new this.parent({theme: this.theme+"_internal", level: this.internal_level, log_title: "Bracket Print Error"})
			//							.s("Option", n, "is not a brackit print option. Use .list() to see all user configurable options:").line(this.list()).log()
								}
						}
					}
					else {
