			...
			return (function() {
				...
				if ( this.style) {
					...
					if ( this.title ) {
						...
						console.log.apply(console, this.apply_arguments.concat([formated_title + this.toStyleString()], tmp_apply_args))
					}
					else {
						console.log.apply(console, this.apply_arguments.concat([this.toStyleString()], tmp_apply_args))
					}
				} else {
