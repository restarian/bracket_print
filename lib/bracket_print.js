...
define(["./proto_object", "./style_map"], function(obj, style_map) {
...
"use strict";
	...
	obj.__defineGetter__("currentPlatform", function() {
		...
		if ( typeof this.style_map[this.platform] !== "object" ) 
			return new this.parent(this, {style: false, platform: "none", level: this.internal_level, log_title: "Bracket Print Error"})
	...
	// theme option is not found in the style platform. 
		...
		if ( platform.import_theme_from ) {
			if ( ! platform.import_theme_from in this.style_map ) 
				return new this.parent(this, {style: false, level: this.internal_level, log_title: "Bracket Print Error"}).s()
					.log_null("The requested import theme", currentPlatform.import_theme_from, "is not included in the style mapping.")
			else {
		...
		if ( typeof theme !== "object" ) 
			return new this.parent(this, {style: false, level: this.internal_level, log_title: "Bracket Print Error"})
			.s("The theme", level_theme, "is not found in the platform", platform_name).log()
