...
Print.prototype = {
  ...
  Shim: function(settings) {
    ...
    if ( this.platform.toLowerCase() === "terminal" ) {
      this.colors = new Print.Terminal_colors()
    }
...
Print.Terminal_colors.prototype = {
 ...
 var fake_logger = new (function() { // The FakePrint is used to disable logging when debug is set to false (it is efficiant this way).
     ...
     this.log_null = function() { return null }
     this.log_empty = function() { return "" }
 })()
...
;(function() {
  ...
  var main_sequence = {}
  // Store all of the original prototype qualifiers before the Shim prototype is added.
  ...
  for ( var n in Print.prototype.Shim.prototype ) {
    if ( typeof Print.prototype[n] === "undefined" && n.charAt(0) !== "_" ) {
      var forward = function() {
        ...
        // If the cmd qualifier was already in the Print prototype before the shim prototype was added then it is access regardless of the debug level.
        if ( cmd in main_sequence ) {
          ...
          if ( this.debug === "verbose" || this._always ) {
            ...
            // This is a simple empty function which disables the Print mechinism entirely.
            return fake_logger
          }
        }
      }
