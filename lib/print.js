...
//          p.set_option({debug_level: "err"}).log("Option", n, "is not a brackit print option. Use _mutable_options() to see all user configurable options.")
          p.log("Option", n, "is not a brackit print option. Use _mutable_options() to see all user configurable options.")
        }
    return p
  },
  new_copy: function() {
...
var b = function ff(ss) {
  var t = "" }
//var c = function  (ss) { var t = "" }
function dddd() { var t = "" }
Print().set_option({max_depth: 3, compress_level: 2, compress_function: !true, theme: "light"}).log({aaaa: a})//, String)
