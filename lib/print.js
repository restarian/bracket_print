...
Print.prototype.toColorString = function() {
  ...
  return this._print_command(this._last_command || "space").apply(this, arguments).bufferize.formated
}
...
console.log(Print().set_option({compress_level: 2}).toColorString(a)
*/

		var obj_a = new Object("aa")
		obj_a.prop_a = true
console.log(Print().set_option({compress_level: 4, use_title: false}).toColorString(obj_a) )
