...
Print.prototype = {
  ...
  set_option: function() {
   ...
   if ( this._is_fresh === "undefined" ) {
     var p = Print()
     p._is_fresh = false
     return p["set_option"].apply(p, arguments)
   }
  ...
  _mutable_options: function() {
   ...
   _print_command: function(call_name) {
     ...
     var p = this._chained && this || new Print()
     this._chained = true
   ...
   get sp() { // Alias for space. This creates text with a white space used for seperation.
     ...
     return this._print_command(arguments.callee.name.substr(4))
   },
   get space() {
