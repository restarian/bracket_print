...
;(function(o) {
  ...
  if ( cnt > 5 )
    return
    o[cnt] = {here: [1, 2, null, 4*"ss", undefined, function() {

      var ss = true; }, true, false, 5, Function, Number, 5, Object, Error], cool: "joe", bob: "real"}
    //o[cnt] = {here: [1, 2, null, 4*"ss", undefined, Function, true, false, Number, Object], cool: "joe", bob: "real"}
  arguments.callee(o[cnt])
})(o)

Print().set_option({compress_function: false, max_depth: 3, use_title: false}).log(o)
