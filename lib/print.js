...
for ( var x in color_map ) {
  ...
  color_map[x].remove_call = function() {
    ...
    this.formated = this.formated.substr(0, this.formated_index.splice.apply(this.formated_index, arguments)[0] || 0)
    this.plain = this.plain.substr(0, this.plain_index.splice.apply(this.plain_index, arguments)[0] || 0)
  }
  ...
  Object.keys(color_map[x][color_map[x]._installed_theme[0]]).forEach(function(val) {
    ...
    this[val] = function() {
      ...
      Print._mapping.apply(this, arguments)
    }
