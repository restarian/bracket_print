       ...
       for ( var n = 0; n < level; n++ ) {
         for ( var x = 0; x < this._cache[n].length; x++ ) {
           if ( typeof msg === "object" && msg === this._cache[n][x] ) {
             ...
             return modify_string.namespace(circ_text) + modify_string.scope_container("{ ")+modify_string.function_body(obj_qualifier)+modify_string.scope_container(" } ]]")
           }
         }
       }
...
var color_map = {
 ...
 terminal: Object.create({
   light: {
      ...
      function_body: "\033[0;34m",
      not_a_number: "\033[0;33m",
      null: "\033[0;36m",
      boolean: "\033[0;31m",
      comma: "\033[0;97m",
      undefined: "\033[0;33m",
      scope_container: "\033[0;29m",
      colon: "\033[0;233m",
      namespace: "\033[0;88m", // e.g. .__proto__ [[primitivevalue}}1
      indent: "\033[0;233m", // e.g. .__proto__ [[primitivevalue}}1
      title: "\033[0;16m", // e.g. .__proto__ [[primitivevalue}}1
   ...
   dark: {
      ...
      boolean: "\033[0;31m",
      comma: "\033[0;97m",
      undefined: "\033[0;214m",
      scope_container: "\033[0;29m",
      colon: "\033[0;7m",
      namespace: "\033[0;88m", // e.g. .__proto__ [[primitivevalue}}1
      indent: "\033[0;240m", // e.g. .__proto__ [[primitivevalue}}1
      title: "\033[0;7m", // e.g. .__proto__ [[primitivevalue}}1
...
for ( var x in color_map )
 Object.keys(color_map[x].light).forEach(function(val, index) {
   ...
   this[val] = function(str) {
     if ( !this.use_color )
      return str.toString()
     var color_value = this.__proto__[this.theme][arguments.callee.command_name]
     return this.format(str, color_value)
   }
...
Print().set_option({max_depth: 3, max_line_characters: 30, theme: "light"}).log(a)
