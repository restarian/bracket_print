...
define([], function() {
	...
	return {
		...
		browser: {
			...
			theme_override: {
				"light_2": {"wrap_start": "", "wrap_end": ""},
				"dark_2": {"wrap_start": "", "wrap_end": ""},
			},
		...
		html: {
			...
			theme: {
				...
				light_1: {
					...
					brace: "color: #242d55",
					bracket: "color: #053d39",
					parameter: "color: #3e414b",
					parenthesis: "color: #242736",
				},
				light_2: {
					base: "color: darkgrey",
					wrap_start: "<span style='font-weight: bold'>",
					wrap_end: "</span>",
					quote: "color: #454343",
					number: "color: green",
					string: "color: #b91db3",
				...
				dark_1: {
					...
					brace: "color: #242d55",
					bracket: "color: #242d55",
					parameter: "color: #242d55",
					parenthesis: "color: #0d1431",
		 ...
		 terminal: {
			...
			wrap_end: "\033[0m", // This will be added after a toStyleString call (which is used with log as well). It will also be added whenever 
											// the style option is set to false. This will not be used if a wrap_end value is set in the theme below.
