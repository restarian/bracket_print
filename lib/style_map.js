	...
	return {
		...
		html: {
		 ...
		 terminal: {
			...
			denote_line: "\n", // The newline insert characters.
			denote_tab: "\t;", // The tab insert characters.
			denote_space: " ", // The space insert characters.
			default_theme: "light_1", // Use this if the set level or theme does not exist below.
			//use_theme_from: null, // This can be the property name of another theme or falsey or omitted.
			format: function(style_value, val) {
			// format is called every time a argument from the call chain is stylized. This will not be used is use_style is falsey. The style value is
			...
			theme: {
				...
				light_1: {
					...
					number: "\033[0;32m", 
					string: "\033[0;35m",
					function_body: "\033[0;30m", // The contents of a function. This will include truncated denotations.
