	 ...
	 var a
	   var a
		...
		it("serializes functions correctly using compression level 5", function() {
			...
			up = Print({compression: 5, indentation_string: ind, shift_function_body: false})
			//expect(up.toString(f6)).to.equal("{bob(a,b,c){}}")
		})
		...
		it.skip("serializes functions correctly using compression level 3", function() {
		...
		it.skip("serializes functions correctly using compression level 2", function() {
		...
		it.skip("serializes functions correctly using compression level 2 with the shift_function_body option set", function() {
		...
		it.skip("serializes functions correctly using compression level 1", function() {
		...
		it.skip("serializes functions correctly using compression level 1 with the shift_function_body option set", function() {
